...
namespace FinalProject.Controllers
{
    ...
    public class ProjectsAllController : Controller
    {
        ...
        public ProjectsAllController(FinalProjectContext context)
        {
            _context = context;
        }
